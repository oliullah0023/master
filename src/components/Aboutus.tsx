...
const Aboutus = () => {
  return (
    <div className="  my-6  mx-6 md:mx-36 overflow-hidden ">
      ...
      <div className=' gap-2 '>
      <h1 className=" absolute text-5xl  font-extrabold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text text-center top-50 items-center flex md:text-8xl">Master Academy</h1>
